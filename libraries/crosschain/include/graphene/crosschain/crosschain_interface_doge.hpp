...
namespace graphene {
	namespace crosschain {
		...
		class crosschain_interface_doge : public abstract_crosschain_interface
		{
		public:
			crosschain_interface_doge() {}
			virtual ~crosschain_interface_doge() {}
		...
		private:
			...
			std::string _rpc_url;
			const std::string chain_type = "DOGE";
