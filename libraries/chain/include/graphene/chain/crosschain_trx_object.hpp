...
namespace graphene {
	namespace chain {
		...
		enum eth_multi_account_trx_state {
			sol_create_need_wallfacer_sign = 0,
			sol_create_wallfacer_signed = 1,
		...
		enum transaction_stata {
			...
			withdraw_canceled =6,
			withdraw_eth_wallfacer_need_sign = 7,
			withdraw_eth_wallfacer_sign = 8
		};
...
FC_REFLECT_ENUM(graphene::chain::eth_multi_account_trx_state,(sol_create_need_wallfacer_sign)(sol_create_wallfacer_signed)(sol_multi_account_ethchain_create)(sol_create_comlete))
...
(withdraw_canceled)
(withdraw_eth_wallfacer_need_sign)
(withdraw_eth_wallfacer_sign)
)
