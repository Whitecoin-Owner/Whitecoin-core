 ...
 * instead if you have the choice (see eth_secp256k1_ecdsa_signature_parse_der and
 * eth_secp256k1_ecdsa_signature_parse_compact).
 *
...
#ifndef _ETH_SECP256K1_CONTRIB_LAX_DER_PARSING_H_
#define _ETH_SECP256K1_CONTRIB_LAX_DER_PARSING_H_
