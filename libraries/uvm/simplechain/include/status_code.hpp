...
namespace SimpleWeb {
  ...
  inline StatusCode status_code(const std::string &status_code_string) BOOST_NOEXCEPT {
  ...
  inline const std::string &status_code(StatusCode status_code_enum) BOOST_NOEXCEPT {
